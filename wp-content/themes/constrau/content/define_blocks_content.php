				...
				<span class="general-meta comment second_font">
					...
					<span class="right">                   
						<?php comments_popup_link(
							esc_html__(' 0 bình luận', 'constrau'), 
							esc_html__(' 1 bình luận', 'constrau'), 
							' % '.esc_html__('bình luận', 'constrau'),
							'',
		...
		function constrau_content_readmore( ) { ?>
			<div class="post-footer">
				<div class="post-readmore-constrau">
					<a href="<?php the_permalink(); ?>"><?php  esc_html_e('ĐỌC THÊM', 'constrau'); ?></a>
				</div>
			</div>
		<?php }
	}
			...
			<footer class="post-tag-constrau">
				<?php if(has_tag()){ ?>
					<div class="post-tags-constrau">
						<span class="ovatags second_font"><?php esc_html_e('Thẻ: ', 'constrau'); ?></span>
						<?php the_tags('','',''); ?>
					</div>
				<?php } ?>
				...
				<?php if( has_filter( 'ova_share_social' ) ){ ?>
					<div class="share_social-constrau">
						<span class="text-social second_font"><?php echo esc_html_e("CHIA SẺ: ", 'constrau') ?></span>
		...
		<li <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
			<article class="comment_item" id="comment-<?php comment_ID(); ?>">
				...
				<?php if ($comment->comment_approved == '0') : ?>
					<em><?php esc_html_e('Comment đang được gửi đi.', 'constrau') ?></em>
					<br />
				<?php endif; ?>
